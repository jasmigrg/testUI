...
<head>
  ...
  <title>Margin Funding Contract Maintenance - Add</title>
  ...
  <script>
    ...
    window.MFCC_LIST_PAGE_URL = window.MFCC_LIST_PAGE_URL || '${ctx}/margin-funding-contract-maintenance';
    window.MFCC_ENTITY_NAME = window.MFCC_ENTITY_NAME || 'distribution-fee-contract-attribute';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mfcContractMaintenanceAddGrid: 'id_margin_funding_contract_maintenance_add'
    });
  </script>
  ...
  <script src="${ctx}/js/margin-funding-contract-maintenance-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/margin-funding-contract-maintenance/add" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Margin Funding Contract Maintenance"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Margin Funding Contract Maintenance","href":"${ctx}/margin-funding-contract-maintenance"},{"label":"Add"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Margin funding contract maintenance add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="Margin funding contract maintenance upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mfcContractBatchRefreshHelp"
                    >?</button>
                    <span id="mfcContractBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="Margin funding contract maintenance upload jobs"></div>
          </div>
        </section>
        ...
        <section class="grid-wrapper">
          <div id="mfcContractMaintenanceAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
