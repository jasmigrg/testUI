    ...
    <ul class="sidebar-menu">
        ...
        <li class="menu-item has-submenu">
            ...
            <ul class="submenu">
                ...
                <li class="submenu-item">
                    <a href="/manage-mck-brand-logic" class="submenu-link" title="Manage McK Brand Logic">
                        <span class="text">Manage McK Brand Logic</span>
                    </a>
                </li>
                <li class="submenu-item">
                    <a href="/price-rules-reason-codes" class="submenu-link" title="Price Rules Reason Codes">
                        <span class="text">Price Rules Reason Codes</span>
                    </a>
                </li>
            </ul>
        </li>
