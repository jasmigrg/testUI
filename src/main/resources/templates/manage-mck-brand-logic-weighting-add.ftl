...
<head>
  ...
  <title>Manage McK Brand Logic - Add Weighting</title>
  ...
  <script>
    ...
    window.MCK_WEIGHTING_ENTITY_NAME = window.MCK_WEIGHTING_ENTITY_NAME || 'mckb-split-price-scoring-weighting';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mckWeightingAddGrid: 'id_mck_brand_logic_weighting_add'
    });
  </script>
  ...
  <script src="${ctx}/js/manage-mck-brand-logic-weighting-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/manage-mck-brand-logic/add/weighting" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Manage McK Brand Logic"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Manage McK Brand Logic","href":"${ctx}/manage-mck-brand-logic?tab=weighting"},{"label":"Add Weighting"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="McK weighting add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="McK weighting upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mckWeightingBatchRefreshHelp"
                    >?</button>
                    <span id="mckWeightingBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="McK weighting upload jobs"></div>
          </div>
        </section>
        ...
        <section class="screen-add-status-row" id="screenAddUploadStatusRow" hidden>
          <label class="screen-add-status-option">
            <input type="radio" name="mckWeightingUploadStatus" value="all" checked />
            <span>All</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckWeightingUploadStatus" value="success" />
            <span>Success</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckWeightingUploadStatus" value="error" />
            <span>Error</span>
          </label>
        </section>

        <section class="grid-wrapper">
          <div id="mckWeightingAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
