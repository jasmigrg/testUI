...
<head>
  ...
  <title>Manage McK Brand Logic - Add Quality Tier</title>
  ...
  <script>
    ...
    window.MCK_QUALITY_TIER_ENTITY_NAME = window.MCK_QUALITY_TIER_ENTITY_NAME || 'gm-core-parameter-mckb-quality-tiers';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mckQualityTierAddGrid: 'id_mck_brand_logic_quality_tier_add'
    });
  </script>
  ...
  <script src="${ctx}/js/manage-mck-brand-logic-quality-tier-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/manage-mck-brand-logic/add/quality-tier" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Manage McK Brand Logic"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Manage McK Brand Logic","href":"${ctx}/manage-mck-brand-logic?tab=quality-tier"},{"label":"Add Quality Tier"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="McK quality tier add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="McK quality tier upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mckQualityTierBatchRefreshHelp"
                    >?</button>
                    <span id="mckQualityTierBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="McK quality tier upload jobs"></div>
          </div>
        </section>
        ...
        <section class="screen-add-status-row" id="screenAddUploadStatusRow" hidden>
          <label class="screen-add-status-option">
            <input type="radio" name="mckQualityTierUploadStatus" value="all" checked />
            <span>All</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckQualityTierUploadStatus" value="success" />
            <span>Success</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckQualityTierUploadStatus" value="error" />
            <span>Error</span>
          </label>
        </section>

        <section class="grid-wrapper">
          <div id="mckQualityTierAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
