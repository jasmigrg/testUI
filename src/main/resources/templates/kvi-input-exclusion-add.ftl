...
<head>
  ...
  <title>KVI Input Exclusion - Add</title>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/kvi-input-exclusion/add" />
    ...
    <main class="content">
      <div class="content-card">
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="KVI input exclusion add actions" rightSectionLabel="Grid manager view actions">
