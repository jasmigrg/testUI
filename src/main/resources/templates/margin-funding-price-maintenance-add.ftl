...
<head>
  ...
  <title>Margin Funding Price Maintenance - Add</title>
  ...
  <script>
    ...
    window.MFP_LIST_PAGE_URL = window.MFP_LIST_PAGE_URL || '${ctx}/margin-funding-price-maintenance';
    window.MFP_ENTITY_NAME = window.MFP_ENTITY_NAME || 'distribution-fee-pricing-attribute';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mfpPriceMaintenanceAddGrid: 'id_margin_funding_price_maintenance_add'
    });
  </script>
  ...
  <script src="${ctx}/js/margin-funding-price-maintenance-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/margin-funding-price-maintenance/add" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Margin Funding Price Maintenance"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Margin Funding Price Maintenance","href":"${ctx}/margin-funding-price-maintenance"},{"label":"Add"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Margin funding price maintenance add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="Margin funding price maintenance upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mfpPriceBatchRefreshHelp"
                    >?</button>
                    <span id="mfpPriceBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="Margin funding price maintenance upload jobs"></div>
          </div>
        </section>
        ...
        <section class="grid-wrapper">
          <div id="mfpPriceMaintenanceAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
