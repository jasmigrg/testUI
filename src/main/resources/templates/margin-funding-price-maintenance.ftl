...
<head>
  ...
  <title>Margin Funding Price Maintenance</title>
  ...
  <link rel="stylesheet" href="${ctx}/css/margin-funding-price-maintenance.css">
  ...
  <script>
    ...
    window.MFP_ADD_PAGE_URL = window.MFP_ADD_PAGE_URL || '${ctx}/margin-funding-price-maintenance/add';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mfpPriceGrid: 'id_margin_funding_price_maintenance'
    });
  </script>
  ...
  <script src="${ctx}/js/margin-funding-price-maintenance.js" defer></script>
...
<body class="mfi-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/margin-funding-price-maintenance" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Margin Funding Price Maintenance"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Pricing","href":"${ctx}/pricing-inquiry"},{"label":"Margin Funding Price Maintenance"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Margin funding price actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" />
        </@actionToolbar.render>

        <section class="grid-wrapper">
          <div id="mfpPriceGrid" class="ag-theme-alpine app-grid"></div>
        </section>
      </div>
    </main>
  </div>
