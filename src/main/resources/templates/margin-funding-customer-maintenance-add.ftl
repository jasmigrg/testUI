...
<head>
  ...
  <title>Margin Funding Customer Maintenance - Add</title>
  ...
  <script>
    ...
    window.MFC_LIST_PAGE_URL = window.MFC_LIST_PAGE_URL || '${ctx}/margin-funding-customer-maintenance';
    window.MFC_ENTITY_NAME = window.MFC_ENTITY_NAME || 'distribution-fee-customer-attribute';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mfcCustomerMaintenanceAddGrid: 'id_margin_funding_customer_maintenance_add'
    });
  </script>
  ...
  <script src="${ctx}/js/margin-funding-customer-maintenance-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/margin-funding-customer-maintenance/add" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Margin Funding Customer Maintenance"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Margin Funding Customer Maintenance","href":"${ctx}/margin-funding-customer-maintenance"},{"label":"Add"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Margin funding customer maintenance add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="Margin funding customer maintenance upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mfcCustomerBatchRefreshHelp"
                    >?</button>
                    <span id="mfcCustomerBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="Margin funding customer maintenance upload jobs"></div>
          </div>
        </section>
        ...
        <section class="grid-wrapper">
          <div id="mfcCustomerMaintenanceAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
