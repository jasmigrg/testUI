...
<head>
  ...
  <script>
    ...
    window.KVI_MAPPING_ENTITY_NAME = window.KVI_MAPPING_ENTITY_NAME || 'kvi-mapping-paramter';
  ...
  <div class="app-shell">
    ...
    <main class="content">
      <div class="content-card">
        ...
        <section class="bulk-upload-batch-section is-collapsed" aria-label="KVI mapping upload jobs">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="kviMappingBatchRefreshHelp"
                    >?</button>
                    <span id="kviMappingBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
