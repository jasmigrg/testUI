...
<head>
  ...
  <script>
    ...
    window.KVI_RECOMMENDATION_ENTITY_NAME = window.KVI_RECOMMENDATION_ENTITY_NAME || 'kvi-recommendation-parameter';
    ...
    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          ...
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Manage KVI Recommendation Logic and View Output Data","href":"${ctx}/manage-kvi-recommendation-logic-view-output-data"},{"label":"Add"}]
        />
        ...
        <section class="bulk-upload-batch-section is-collapsed" aria-label="KVI upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="kviRecommendationBatchRefreshHelp"
                    >?</button>
                    <span id="kviRecommendationBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="KVI upload jobs"></div>
          </div>
        </section>
        ...
        <section class="grid-wrapper">
          <div id="kviRecommendationParameterAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
