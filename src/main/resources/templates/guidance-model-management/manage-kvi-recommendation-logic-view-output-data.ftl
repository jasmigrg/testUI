  ...
  <div class="app-shell">
    ...
    <main class="content">
      <div class="content-card grid-content-card-compact">
        ...
        <section class="kvi-page-shell tabbed-grid-page" aria-label="Manage KVI Recommendation Logic and View Output Data">
          <div class="kvi-tabs tabbed-grid-tabs" role="tablist" aria-label="KVI recommendation tabs">
            <button
              type="button"
          ...
          >
            <section class="grid-wrapper">
              <div id="kviParameterGrid" class="ag-theme-alpine app-grid app-grid-standard"></div>
            </section>
          </section>
          ...
          >
            <section class="grid-wrapper">
              <div id="kviOutputGrid" class="ag-theme-alpine app-grid app-grid-standard"></div>
            </section>
          </section>
        </section>
      </div>
