...
<head>
  ...
  <link rel="stylesheet" href="${ctx}/css/add-screen.css">
...
<body class="grid-page grid-add-page">
  ...
  <div class="app-shell">
    ...
    <main class="content">
      <div class="content-card grid-content-card-compact">
        ...
        <#assign iconSubmit><@toolbarIcons.render name="submit" /></#assign>
        ...
        <section class="grid-add-upload-row">
          <button type="button" class="grid-add-upload-btn" data-action="bulk-upload">Bulk Upload</button>
        </section>

        <section class="grid-add-status-row" id="kviUploadStatusRow" hidden>
          <label class="grid-add-status-option">
        ...
        <section class="grid-wrapper">
          <div id="kviRecommendationParameterAddGrid" class="ag-theme-alpine app-grid app-grid-standard"></div>
        </section>
      </div>
    </main>
  </div>
