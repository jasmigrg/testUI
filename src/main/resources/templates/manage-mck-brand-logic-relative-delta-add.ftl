...
<head>
  ...
  <title>Manage McK Brand Logic - Add Relative Delta</title>
  ...
  <script>
    ...
    window.MCK_BRAND_LOGIC_PAGE_URL = window.MCK_BRAND_LOGIC_PAGE_URL || '${ctx}/manage-mck-brand-logic';
    window.MCK_RELATIVE_DELTA_ENTITY_NAME = window.MCK_RELATIVE_DELTA_ENTITY_NAME || 'gm-core-parameter-mckb-relative-price-delta';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      mckRelativeDeltaAddGrid: 'id_mck_brand_logic_relative_delta_add'
    });
  </script>
  ...
  <script src="${ctx}/js/manage-mck-brand-logic-relative-delta-add.js" defer></script>
...
<body class="mfi-page screen-page screen-add-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/manage-mck-brand-logic/add/relative-delta" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Manage McK Brand Logic"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Manage McK Brand Logic","href":"${ctx}/manage-mck-brand-logic?tab=relative-delta"},{"label":"Add Relative Delta"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="McK relative delta add actions" rightSectionLabel="Grid manager view actions">
          <@gridManager.gridManager />
          <@gridViewActions.render defaultDensity="compact" showDownload=false />
        </@actionToolbar.render>

        <section class="bulk-upload-batch-section is-collapsed" aria-label="McK relative delta upload jobs">
          ...
          <div id="bulkUploadBatchGrid" class="bulk-upload-batch-grid">
                ...
                <span class="bulk-upload-batch-header-help">
                  ...
                  <span class="bulk-upload-batch-help">
                    <button
                      ...
                      aria-describedby="mckRelativeDeltaBatchRefreshHelp"
                    >?</button>
                    <span id="mckRelativeDeltaBatchRefreshHelp" class="bulk-upload-batch-help-tooltip" role="tooltip">
            ...
            <div id="bulkUploadBatchTableBody" class="bulk-upload-batch-list" role="list" aria-label="McK relative delta upload jobs"></div>
          </div>
        </section>
        ...
        <section class="screen-add-status-row" id="screenAddUploadStatusRow" hidden>
          <label class="screen-add-status-option">
            <input type="radio" name="mckRelativeDeltaUploadStatus" value="all" checked />
            <span>All</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckRelativeDeltaUploadStatus" value="success" />
            <span>Success</span>
          </label>
          <label class="screen-add-status-option">
            <input type="radio" name="mckRelativeDeltaUploadStatus" value="error" />
            <span>Error</span>
          </label>
        </section>

        <section class="grid-wrapper">
          <div id="mckRelativeDeltaAddGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
