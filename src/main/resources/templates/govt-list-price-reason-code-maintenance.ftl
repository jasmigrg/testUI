...
<head>
  ...
  <title>Govt List Price Reason Code Maintenance</title>
  ...
  <script>
    ...
    window.GLPRC_ADD_PAGE_URL = window.GLPRC_ADD_PAGE_URL || '${ctx}/govt-list-price-reason-code-maintenance/add';
    window.GRID_PREF_SCREEN_ID_BY_GRID = Object.assign({}, window.GRID_PREF_SCREEN_ID_BY_GRID, {
      govtListPriceReasonCodeGrid: 'id_govt_list_price_reason_code_maintenance'
    });
  </script>
  ...
  <script src="${ctx}/js/govt-list-price-reason-code-maintenance.js" defer></script>
  <script src="https://cdn.jsdelivr.net/npm/ag-grid-community@31.0.1/dist/ag-grid-community.min.js"></script>
</head>
<body class="mfi-page screen-page govt-reason-page">
  ...
  <div class="app-shell">
    <@sidebar.navigation currentPath="/govt-list-price-reason-code-maintenance" />

    <main class="content">
      <div class="content-card">
        <@pageHeader.render
          title="Govt List Price Reason Code Maintenance - Work With User Defined Codes"
          crumbs=[{"label":"Home","href":"${ctx}/"},{"label":"Government"},{"label":"Govt List Price Reason Code Maintenance - Work With User Defined Codes"}]
        />
        ...
        <@actionToolbar.render actions=actionItems toolbarLabel="Government list price reason code actions" showRightSection=false />

        <section class="govt-reason-summary-card" aria-label="Government reason code summary">
          <div class="govt-reason-summary-grid">
        ...
        <section class="grid-wrapper">
          <div id="govtListPriceReasonCodeGrid" class="ag-theme-alpine app-grid screen-grid"></div>
        </section>
      </div>
    </main>
  </div>
